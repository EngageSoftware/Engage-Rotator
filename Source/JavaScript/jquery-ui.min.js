...
*/
(function(C){var H=C.fn.remove,A=C.browser.mozilla&&(parseFloat(C.browser.version)<1.9);C.ui={version:"1.6rc2.5",plugin:{add:function(L,M,J){var K=C.ui[L].prototype;for(var N in J){K.plugins[N]=K.plugins[N]||[];K.plugins[N].push([M,J[N]]);}},call:function(M,K,L){var J=M.plugins[K];if(!J){return;}for(var N=0;N<J.length;N++){if(M.options[J[N][0]]){J[N][1].apply(M.element,L);}}}},contains:function(K,L){var J=C.browser.safari&&C.browser.version<522;if(K.contains&&!J){return K.contains(L);}if(K.compareDocumentPosition){return !!(K.compareDocumentPosition(L)&16);}while(L=L.parentNode){if(L==K){return true;}}return false;},cssCache:{},css:function(J){if(C.ui.cssCache[J]){return C.ui.cssCache[J];}var K=C('<div class="ui-gen">').addClass(J).css({position:"absolute",top:"-5000px",left:"-5000px",display:"block"}).appendTo("body");C.ui.cssCache[J]=!!((!(/auto|default/).test(K.css("cursor"))||(/^[1-9]/).test(K.css("height"))||(/^[1-9]/).test(K.css("width"))||!(/none/).test(K.css("backgroundImage"))||!(/transparent|rgba\(0, 0, 0, 0\)/).test(K.css("backgroundColor"))));try{C("body").get(0).removeChild(K.get(0));}catch(L){}return C.ui.cssCache[J];},hasScroll:function(J,K){if(C(J).css("overflow")=="hidden"){return false;}var L=(K&&K=="left")?"scrollLeft":"scrollTop",M=false;if(J[L]>0){return true;}J[L]=1;M=(J[L]>0);J[L]=0;return M;},isOverAxis:function(K,L,J){return(K>L)&&(K<(L+J));},isOver:function(K,J,L,O,M,N){return C.ui.isOverAxis(K,L,M)&&C.ui.isOverAxis(J,O,N);},keyCode:{BACKSPACE:8,CAPS_LOCK:20,COMMA:188,CONTROL:17,DELETE:46,DOWN:40,END:35,ENTER:13,ESCAPE:27,HOME:36,INSERT:45,LEFT:37,NUMPAD_ADD:107,NUMPAD_DECIMAL:110,NUMPAD_DIVIDE:111,NUMPAD_ENTER:108,NUMPAD_MULTIPLY:106,NUMPAD_SUBTRACT:109,PAGE_DOWN:34,PAGE_UP:33,PERIOD:190,RIGHT:39,SHIFT:16,SPACE:32,TAB:9,UP:38}};if(A){var B=C.attr,D=C.fn.removeAttr,G="http://www.w3.org/2005/07/aaa",E=/^aria-/,I=/^wairole:/;C.attr=function(L,K,M){var J=M!==undefined;return(K=="role"?(J?B.call(this,L,K,"wairole:"+M):(B.apply(this,arguments)||"").replace(I,"")):(E.test(K)?(J?L.setAttributeNS(G,K.replace(E,"aaa:"),M):B.call(this,L,K.replace(E,"aaa:"))):B.apply(this,arguments)));};C.fn.removeAttr=function(J){return(E.test(J)?this.each(function(){this.removeAttributeNS(G,J.replace(E,""));}):D.call(this,J));};}C.fn.extend({remove:function(){C("*",this).add(this).each(function(){C(this).triggerHandler("remove");});return H.apply(this,arguments);},enableSelection:function(){return this.attr("unselectable","off").css("MozUserSelect","").unbind("selectstart.ui");},disableSelection:function(){return this.attr("unselectable","on").css("MozUserSelect","none").bind("selectstart.ui",function(){return false;});},scrollParent:function(){var J;if((C.browser.msie&&(/(static|relative)/).test(this.css("position")))||(/absolute/).test(this.css("position"))){J=this.parents().filter(function(){return(/(relative|absolute|fixed)/).test(C.curCSS(this,"position",1))&&(/(auto|scroll)/).test(C.curCSS(this,"overflow",1)+C.curCSS(this,"overflow-y",1)+C.curCSS(this,"overflow-x",1));}).eq(0);}else{J=this.parents().filter(function(){return(/(auto|scroll)/).test(C.curCSS(this,"overflow",1)+C.curCSS(this,"overflow-y",1)+C.curCSS(this,"overflow-x",1));}).eq(0);}return(/fixed/).test(this.css("position"))||!J.length?C(document):J;}});C.extend(C.expr[":"],{data:function(K,L,J){return C.data(K,J[3]);},tabbable:function(L,N,J){var K=L.nodeName.toLowerCase();function M(O){return !(C(O).is(":hidden")||C(O).parents(":hidden").length);}return(L.tabIndex>=0&&(("a"==K&&L.href)||(/input|select|textarea|button/.test(K)&&"hidden"!=L.type&&!L.disabled))&&M(L));}});function F(J,N,K,L){function M(Q){var P=C[J][N][Q]||[];return(typeof P=="string"?P.split(/,?\s+/):P);}var O=M("getter");if(L.length==1&&typeof L[0]=="string"){O=O.concat(M("getterSetter"));}return(C.inArray(K,O)!=-1);}C.widget=function(K,L){var J=K.split(".")[0];K=K.split(".")[1];C.fn[K]=function(P){var N=(typeof P=="string"),M=Array.prototype.slice.call(arguments,1);if(N&&P.substring(0,1)=="_"){return this;}if(N&&F(J,K,P,M)){var O=C.data(this[0],K);return(O?O[P].apply(O,M):undefined);}return this.each(function(){var Q=C.data(this,K);(!Q&&!N&&C.data(this,K,new C[J][K](this,P)));(Q&&N&&C.isFunction(Q[P])&&Q[P].apply(Q,M));});};C[J]=C[J]||{};C[J][K]=function(N,O){var M=this;this.widgetName=K;this.widgetEventPrefix=C[J][K].eventPrefix||K;this.widgetBaseClass=J+"-"+K;this.options=C.extend({},C.widget.defaults,C[J][K].defaults,C.metadata&&C.metadata.get(N)[K],O);this.element=C(N).bind("setData."+K,function(R,Q,P){return M._setData(Q,P);}).bind("getData."+K,function(Q,P){return M._getData(P);}).bind("remove",function(){return M.destroy();});this._init();};C[J][K].prototype=C.extend({},C.widget.prototype,L);C[J][K].getterSetter="option";};C.widget.prototype={_init:function(){},destroy:function(){this.element.removeData(this.widgetName);},option:function(K,J){var M=K,L=this;if(typeof K=="string"){if(J===undefined){return this._getData(K);}M={};M[K]=J;}C.each(M,function(O,N){L._setData(O,N);});},_getData:function(J){return this.options[J];},_setData:function(K,J){this.options[K]=J;if(K=="disabled"){this.element[J?"addClass":"removeClass"](this.widgetBaseClass+"-disabled");}},enable:function(){this._setData("disabled",false);},disable:function(){this._setData("disabled",true);},_trigger:function(J,M,K){var L=(J==this.widgetEventPrefix?J:this.widgetEventPrefix+J);M=M||C.event.fix({type:L,target:this.element[0]});return this.element.triggerHandler(L,[M,K],this.options[J]);}};C.widget.defaults={disabled:false};C.ui.mouse={_mouseInit:function(){var J=this;this.element.bind("mousedown."+this.widgetName,function(K){return J._mouseDown(K);}).bind("click."+this.widgetName,function(K){if(J._preventClickEvent){J._preventClickEvent=false;return false;}});if(C.browser.msie){this._mouseUnselectable=this.element.attr("unselectable");this.element.attr("unselectable","on");}this.started=false;},_mouseDestroy:function(){this.element.unbind("."+this.widgetName);(C.browser.msie&&this.element.attr("unselectable",this._mouseUnselectable));},_mouseDown:function(K){(this._mouseStarted&&this._mouseUp(K));this._mouseDownEvent=K;var L=this,J=(K.which==1),M=(typeof this.options.cancel=="string"?C(K.target).parents().add(K.target).filter(this.options.cancel).length:false);if(!J||M||!this._mouseCapture(K)){return true;}this.mouseDelayMet=!this.options.delay;if(!this.mouseDelayMet){this._mouseDelayTimer=setTimeout(function(){L.mouseDelayMet=true;},this.options.delay);}if(this._mouseDistanceMet(K)&&this._mouseDelayMet(K)){this._mouseStarted=(this._mouseStart(K)!==false);if(!this._mouseStarted){K.preventDefault();return true;}}this._mouseMoveDelegate=function(N){return L._mouseMove(N);};this._mouseUpDelegate=function(N){return L._mouseUp(N);};C(document).bind("mousemove."+this.widgetName,this._mouseMoveDelegate).bind("mouseup."+this.widgetName,this._mouseUpDelegate);if(!C.browser.safari){K.preventDefault();}return true;},_mouseMove:function(J){if(C.browser.msie&&!J.button){return this._mouseUp(J);}if(this._mouseStarted){this._mouseDrag(J);return J.preventDefault();}if(this._mouseDistanceMet(J)&&this._mouseDelayMet(J)){this._mouseStarted=(this._mouseStart(this._mouseDownEvent,J)!==false);(this._mouseStarted?this._mouseDrag(J):this._mouseUp(J));}return !this._mouseStarted;},_mouseUp:function(J){C(document).unbind("mousemove."+this.widgetName,this._mouseMoveDelegate).unbind("mouseup."+this.widgetName,this._mouseUpDelegate);if(this._mouseStarted){this._mouseStarted=false;this._preventClickEvent=true;this._mouseStop(J);}return false;},_mouseDistanceMet:function(J){return(Math.max(Math.abs(this._mouseDownEvent.pageX-J.pageX),Math.abs(this._mouseDownEvent.pageY-J.pageY))>=this.options.distance);},_mouseDelayMet:function(J){return this.mouseDelayMet;},_mouseStart:function(J){},_mouseDrag:function(J){},_mouseStop:function(J){},_mouseCapture:function(J){return true;}};C.ui.mouse.defaults={cancel:null,distance:1,delay:0};})(jQuery);
/*
