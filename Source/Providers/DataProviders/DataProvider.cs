...
namespace Engage.Dnn.ContentRotator
{
    ...
    /// <summary>An abstract class for the data access layer</summary>
    public abstract class DataProvider
    {
        /// <summary>Singleton reference to the instantiated object</summary>
        private static readonly DataProvider TheInstance = (DataProvider)DotNetNuke.Framework.Reflection.CreateObject("data", "Engage.Dnn.ContentRotator", string.Empty);

        /// <summary>Gets the reference to the current instance of the <see cref="DataProvider" /></summary>
        ...
        /// <summary>Inserts a new slide.</summary>
        ...
        /// <summary>Updates the slide with the given <see cref="slideId" />.</summary>
        ...
        /// <summary>Deletes the slide with the given <paramref name="slideId" />.</summary>
        /// <param name="slideId">The ID of the slide to delete.</param>
        public abstract void DeleteSlide(int slideId);

        /// <summary>Gets the slide with the given <paramref name="slideId" />.</summary>
        ...
        /// <summary>Gets all of the slides for the given <paramref name="moduleId" />, getting either only slides which have started but not ended, or all slides if <paramref name="getOutdatedSlides" /> is true.</summary>
        /// <param name="moduleId">The module id.</param>
