...
<div class="dnnForm engageRotatorEdit">
    <fieldset>
        <asp:Panel ID="TitlePanel" runat="server" CssClass="dnnFormItem">
        ...
        <asp:Panel ID="ContentPanel" runat="server" CssClass="dnnFormItem">
        ...
        <asp:Panel ID="ImageUrlPanel" runat="server" CssClass="dnnFormItem">
        ...
        <asp:Panel ID="PagerImageUrlPanel" runat="server" CssClass="dnnFormItem">
        ...
        <asp:Panel ID="LinkUrlPanel" runat="server" CssClass="dnnFormItem">
            <asp:UpdatePanel runat="server" UpdateMode="Conditional"><ContentTemplate>
        ...
        <asp:Panel ID="StartDatePanel" runat="server" CssClass="dnnFormItem">
        ...
        <asp:Panel ID="EndDatePanel" runat="server" CssClass="dnnFormItem">
        ...
        <asp:Panel ID="SortOrderPanel" runat="server" CssClass="dnnFormItem">
