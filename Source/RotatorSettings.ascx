...
<div class="engageRotatorSettings">
            ...
            <asp:UpdatePanel runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <table class="settingsTable Normal">
                        ...
                        <tr>
                            <td class="SubHead nowrap DNNAlignright"><dnn:Label ResourceKey="TransitionEffectLabel" runat="server" EnableViewState="false" /></td>
                            <td class="contentColumn DNNAlignleft">
        ...
        <div id="content-settings">
            <asp:UpdatePanel runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <table class="settingsTable Normal">
                        <tr>
                            <td class="SubHead nowrap DNNAlignright"><dnn:Label ResourceKey="SlideHeightLabel" runat="server" EnableViewState="false" /></td>
                            <td class="contentColumn DNNAlignleft">
                        ...
                        <tr>
                            <td class="SubHead nowrap DNNAlignright"><dnn:Label ResourceKey="SlideWidthLabel" runat="server" EnableViewState="false" /></td>
                            <td class="contentColumn DNNAlignleft">
        ...
        <div id="advanced-settings">
            <asp:UpdatePanel runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <table class="settingsTable Normal">
                        <tr>
                            <td class="SubHead nowrap DNNAlignright"><dnn:Label ResourceKey="ContainerResizeLabel" runat="server" EnableViewState="false" /></td>
                            <td class="contentColumn DNNAlignleft">
                                <asp:CheckBox ID="ContainerResizeCheckBox" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="SubHead nowrap DNNAlignright"><dnn:Label ResourceKey="ForceSlidesToFitContainerLabel" runat="server" EnableViewState="false" /></td>
                            <td class="contentColumn DNNAlignleft">
                                <asp:CheckBox ID="ForceSlidesToFitContainerCheckBox" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="SubHead nowrap DNNAlignright"><dnn:Label ResourceKey="ContinuousLabel" runat="server" EnableViewState="false" /></td>
                            <td class="contentColumn DNNAlignleft">
                                <asp:CheckBox ID="ContinuousCheckBox" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="SubHead nowrap DNNAlignright"><dnn:Label ResourceKey="LoopLabel" runat="server" EnableViewState="false" /></td>
                            <td class="contentColumn DNNAlignleft">
                                <asp:CheckBox ID="LoopCheckBox" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td class="SubHead nowrap DNNAlignright"><dnn:Label ResourceKey="RandomOrderLabel" runat="server" EnableViewState="false" /></td>
                            <td class="contentColumn DNNAlignleft">
                        ...
                        <tr>
                            <td class="SubHead nowrap DNNAlignright"><dnn:Label ResourceKey="InitialDelayLabel" runat="server" EnableViewState="false" /></td>
                            <td class="contentColumn DNNAlignleft">
                        ...
                        <tr>
                            <td class="SubHead nowrap DNNAlignright"><dnn:Label ResourceKey="ManuallyTriggeredTransitionSpeedLabel" runat="server" EnableViewState="false" /></td>
                            <td class="contentColumn DNNAlignleft">
...
<script type="text/javascript">
    jQuery(function($) { $('.SettingsContainer').tabs(); });
